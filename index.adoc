...
:keywords: SailPoint, Guidelines, RESTful, API, Events, Schema
...
= SailPoint RESTful API and Event Guidelines
link:https://github.com/sailpoint-oss/sailpoint-api-guidelines[Github Repository]

image::assets/api-guild.jpg[API Guild Logo]

Other formats: link:sailpoint-guidelines.pdf[PDF], link:sailpoint-guidelines.epub[EPUB3] +
