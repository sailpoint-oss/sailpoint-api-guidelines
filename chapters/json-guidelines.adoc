...
For request/response objects, see https://swagger.io/docs/specification/data-models/data-types/#required. If all properties are optional, do not specify the required keyword.
