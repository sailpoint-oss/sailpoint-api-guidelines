...
- Only use the operators [listed here](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filter-syntax). If you are introducing a new operator not in the list, please contact the Developer Relations team to update the list.
