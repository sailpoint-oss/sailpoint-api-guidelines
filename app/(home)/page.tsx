...
const popularRuleCategories = [
  {
    ...
    href: "/docs/rules/resource-modeling-and-urls",
  },
  {
    title: "Security & Authorization",
    href: "/docs/rules/security-and-authorization",
  },
  { title: "HTTP Semantics", href: "/docs/rules/http-semantics" },
  {
    title: "Lifecycle & Compatibility",
    href: "/docs/rules/lifecycle-and-compatibility",
  },
    ...
    <main className="relative overflow-hidden">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-16 sm:gap-16 sm:py-20">
        <header className="flex flex-col gap-6">
          ...
          <div className="flex max-w-3xl flex-col gap-4">
            ...
            <p className="text-pretty text-lg text-fd-muted-foreground">
              Opinionated guard rails for designing consistent, secure,
              evolvable APIs—built for teams shipping integrations to customers
              and partners.
            </p>
          </div>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-xl border border-fd-border bg-fd-card p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-fd-muted-foreground">
              ...
              <kbd className="rounded border px-1.5 py-0.5">K</kbd>) or consume
              the rules as JSON.
            </p>
        ...
        <footer className="flex flex-col gap-2 text-sm text-fd-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>
            Open source API guideline hub for SailPoint teams, customers, and
            partners.
          </p>
          <a
