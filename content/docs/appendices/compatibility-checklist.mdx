...
Need the full classification matrix? See the [Breaking change reference](/docs/appendices/breaking-change-reference).
...
- If the behavior is beta or experimental, is there a documented owner, exit path, and expiration date?
