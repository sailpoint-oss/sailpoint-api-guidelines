...
<RuleHeader id="807" level="MUST" title="Encode Embedded Binary as base64url" externalDocs={[{ href: "https://www.rfc-editor.org/rfc/rfc4648", label: "RFC 4648 — Base16, Base32, Base64 Data Encodings" }]} />
